...
{
	[DisallowMultipleComponent, SelectionBase, Icon("Assets/Huds/Designs/Gwamba Prime Series Logo Show.png"), RequireComponent(typeof(Transform), typeof(Animator), typeof(SortingGroup))]
