...
namespace GwambaPrimeAdventure.Enemy.Supply
{
	...
	public sealed class DeathStatistics : ScriptableObject
	{
		...
		[field: SerializeField, Tooltip( "The projectile that this enemy will spawn in death." )]
		public Projectile ChildProjectile
		{
			get;
			private set;
		}
		[field: SerializeField, Tooltip( "The point to where spawn the object on death relative to this enemy." )]
		public Vector2 SpawnPoint
		{
			get;
			private set;
		}
		[field: SerializeField, Tooltip( "If this enemy will die on touch." )]
		public bool OnTouch
		{
			get;
			private set;
